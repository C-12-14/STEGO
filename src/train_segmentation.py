...
# Labels corresponding to different datasets used: Cityscapes, COCO-Stuff, VOC and Postdam
...
# class declared which inherits the base class pl.LightningModule (AZ)
class LitUnsupervisedSegmenter(pl.LightningModule):
    # constructor (AZ)
    def __init__(self, n_classes, cfg):
        # parent class object initialized into the child class (AZ)
        super().__init__()
        self.cfg = cfg
        ...
        # Deciding the underlying feature extractor (AZ)
        ...
        # Initializing the cluster and linear probe models
    ...
    def on_train_start(self):
        ...
        self.logger.log_hyperparams(tb_metrics)
...
def my_app(cfg: DictConfig) -> None:
    ...
    # model = LitUnsupervisedSegmenter.load_from_checkpoint("/media/agv/81e50d57-ed58-4bd3-9f3a-d695e6ddfa61/STEGO/checkpoints/cocostuff/cocostuff27_exp_cocostuff_no_zero_clamp_date_Jan17_12-34-28/epoch=0-step=3600.ckpt")
    ...
    if cfg.submitting_to_aml:
        ...
        gpu_args = dict(gpus=-1, accelerator="cuda", val_check_interval=cfg.val_freq, strategy="ddp")
